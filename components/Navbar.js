                ...
                <div className="container menu-bar-container w-container">
                    ...
                    <a href="#" className="menu-bar-logo w-nav-brand">
                        ...
                        <div className="col-8 d-flex justify-content-end">
                            <ul className="navbar-nav d-flex flex-row mx-2">
                                {menuItems.map((items, index) => {
                        return (
                            <li className="nav-item m-1 px-1" key={index}>
                            {items.submenu ? (
                                <>
                                ...
                                <ul className="dropdown-menu">
                                    {items.submenu.map((subitems, _index) => {
                                        return (
                                            <li className="dropdown-item" key={_index}>
                                            <Link href={subitems.title}>
                                                <a className="nav-link">{subitems.title}</a>
                                            </Link>
                                            </li>
                                        )
                                    })}
                                ...
                                <a className="nav-link" href="/#">{items.title}</a>
                            )}
                            </li>
                        )
                                })}
                            </ul>
                            <button className="btn btn-outline-dark mx-1 rounded-pill text-nowrap">Request a demo</button>
                            <button className="btn btn-primary mx-1 rounded-pill text-nowrap">Start for Free</button>
                        </div>
                    </div>
                </div>
        </nav>
